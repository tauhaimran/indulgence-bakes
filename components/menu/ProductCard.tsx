      ...
      <div className=\"flex flex-1 flex-col gap-3 px-4 pb-4 pt-4 sm:px-5 sm:pb-5\">
        ...
        <div className=\"mt-2 flex items-center justify-between gap-3\">
          ...
          <button
            type=\"button\"
            onClick={handleAdd}
            className=\"inline-flex min-h-[44px] items-center justify-center rounded-full border border-espresso/20 bg-espresso text-[11px] font-sans uppercase tracking-[0.2em] text-cream px-6 transition-colors hover:bg-espresso/90\"
          >
            Add to Cart
          </button>
        </div>
